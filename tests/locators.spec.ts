...
// 1. if you have an "id" availabe as an attribute - 

// <input type="text" name="username" id="username">

// input - tagname
// type, name and id - attribute

// #valueOfID - #password

// tagname#idvalue - input#password


// 2. If ID is no available
...
// 3. class as an attribute - .valueoftheclassattribute
